	...
	ob_start();
        ...
        columns: [{ field: "ID", title: "ID", hidden: true,width:1 },
				...
				hidden:true
					...
					{ field: "ID_kunde", title: "Id_cliente ", hidden:true,width:1 },
					...
					{ width: 240 ,command: [
						{
							...
							click: function (e) {
								...
								location.replace("<?php echo admin_url('admin.php?page=smart-crm&p=dokumente/document_print.php&id_invoice=')?>"+data.ID )
							},
							...
							click: function (e) {
								...
								if (data.tipo=="P")
									location.href="<?php echo admin_url('admin.php?page=smart-crm&p=dokumente/form_quotation.php&ID=')?>"+data.ID;
								else
									location.href="<?php echo admin_url('admin.php?page=smart-crm&p=dokumente/form_invoice.php&ID=')?>"+data.ID;
							},
							className: "btn _flat"
						},
						{
							...
							click: function(e) {
								...
								if (!confirm("<?php _e('Löschen bestätigen','cpsmartcrm') ?>?"))
									return false;
                  console.log("check");
								location.href="<?php echo admin_url('admin.php?page=smart-crm&p=dokumente/delete.php&ID=')?>"+data.ID +"&security=<?php echo $delete_nonce?>&fromGrid=<?php echo $type?>";
							},
