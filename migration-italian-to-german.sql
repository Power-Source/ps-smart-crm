...
-- Tabellen umbenennen
RENAME TABLE {prefix}clienti TO {prefix}kunde;
...
ALTER TABLE {prefix}kunde CHANGE COLUMN ID_clienti ID_kunde INT(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE {prefix}dokumente CHANGE COLUMN fk_clienti fk_kunde INT(11);
...
ALTER TABLE {prefix}scheduler CHANGE COLUMN fk_clienti fk_kunde INT(11);
